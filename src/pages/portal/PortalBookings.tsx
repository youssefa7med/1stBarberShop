  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950" dir="rtl">
      <div className="max-w-4xl mx-auto p-8">
        ...
        <h1 className="text-4xl font-bold mb-8">احجز موعد جديد</h1>

        <div className="bg-white/5 backdrop-blur border border-white/10 rounded-lg p-12 text-center">
          <div className="text-5xl mb-4">📅</div>
          <h2 className="text-2xl font-bold mb-2 text-white/90">الحجز قيد التطوير</h2>
          <p className="text-white/70 mb-6">
            سيكون نظام الحجز الإلكتروني متاحاً قريباً جداً
          </p>
          <p className="text-white/50 text-sm">
            الرجاء التواصل مع {settings?.shop_name} مباشرة للحجز حالياً
          </p>
        </div>
      </div>
    </div>
